...
$demo_referenz = '
        <p>Die "Extended Beispiele" zeigen über die "Basis Beispiele" hinausgehend, wie mit MForm Elemente individuell um Attribute, Options, Parameter, Label etc. erweitert werden können.</p>
    ';
// parse info fragment
