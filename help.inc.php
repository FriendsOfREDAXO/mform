...
if (!function_exists('mfrom_textileparser')) {
    require_once($path . '/functions/function.mform_textileparser.php');
}

// load lang file
if (!OOAddon::isAvailable($name)) {
...
// add help content
?>
<h3 style="clear:both;padding:15px 0;display:block;"><?php echo $I18N->msg($name . '_help_subheadline_1'); ?></h3>

<?php if (OOAddon::isAvailable($name)): ?>
    <h3 style="clear:both;padding:0 0 15px 0;display:block;">MForm
        v.<?php echo $REX['ADDON']['version'][$name] . $REX['ADDON'][$name]['rc']; ?></h3>
<?php endif; ?>

<p style="margin-bottom:15px;"><?php echo $I18N->msg($name . '_help_infotext_1'); ?></p>
<p style="margin-bottom:15px;"><?php echo mfrom_textileparser($I18N->msg($name . '_help_infotext_2')); ?></p>

<h3 style="clear:both;padding:15px 0;display:block;"><?php echo $I18N->msg($name . '_help_subheadline_2'); ?></h3>

<p style="margin-bottom:15px;"><?php echo $I18N->msg($name . '_help_infotext_3'); ?></p>
<p style="margin-bottom:15px;"><?php echo $I18N->msg($name . '_help_infotext_4'); ?></p>

<h3 style="clear:both;padding:15px 0;display:block;"><?php echo $I18N->msg($name . '_help_subheadline_3'); ?></h3>
