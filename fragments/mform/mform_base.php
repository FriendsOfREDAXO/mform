...
switch ($this->getVar('type')) {
    ...
    case 'headline':
        ...
        break;
    case 'description':
        echo '<div class="form-group mform-description"><p class="'.(($this->getVar('full', false))?'col-sm-12':'col-sm-offset-2 col-sm-10').' small '. $this->getVar('class') .'"><i class="rex-icon rex-icon-info"></i> ' . $this->getVar('output') . '</p></div>';
        break;
    case 'tooltip-info':
