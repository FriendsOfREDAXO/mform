...
- **Dokumentation: Code-Snippet-Kopieren funktioniert wieder zuverlässig** – Der Copy-Button in der Doku funktioniert jetzt auch in nicht-sicheren Kontexten (z. B. lokale Entwicklung ohne HTTPS).
